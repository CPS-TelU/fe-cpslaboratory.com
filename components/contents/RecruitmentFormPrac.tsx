...
const RecruitmentFormPrac: React.FC<RecruitmentFormProps> = ({ onClose }) => {
  const API_URL_REKRU = process.env.NEXT_PUBLIC_API_REKRU_URL;
  const API_URL_REKRU_PRAC= `${API_URL_REKRU}/practicum`;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(API_URL_REKRU_PRAC, {
        method: "POST",
        headers: {
  ...
  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-50 z-[999999] flex justify-end"// Menangkap klik di luar modal untuk menutupnya
    >
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <textarea
                  ...
                  style={{
                    height: "240px", // Set tinggi tetap untuk menampung semua konten
...
export default RecruitmentFormPrac;
