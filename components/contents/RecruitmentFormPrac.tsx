...
const RecruitmentFormPrac: React.FC<RecruitmentFormProps> = ({ onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://be-cyberrecruitment2024.vercel.app/register/practicum", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          gender: formData.gender, // Kirim data gender
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-xl font-bold text-center">Join Our Practicum Team</h2>
